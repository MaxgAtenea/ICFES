...
write_csv(base_cine, "data/SNIES_CINE_cleaned/base_cine_programas_vigencia_2025_18072025.csv")
write_xlsx(base_cine, "data/SNIES_CINE_cleaned/base_cine_programas_vigencia_2025_18072025.xlsx")
