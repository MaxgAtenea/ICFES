...
##Este archivo es para replicar el join de la informacion del icfes con la del snies pero la del snies datando para el 2025
############################################################
...
# Compara los estados de programas entre 2021 y 2022 y retorna solo los que cambiaron.
comparar_estado_programa <- function(df_2021, df_2022) {
  inner_join(
    df_2021,
    df_2022,
    ...
    select(
      ...
      ESTADO_PROGRAMA_2021 = ESTADO_PROGRAMA_2021,
      ESTADO_PROGRAMA_2022 = ESTADO_PROGRAMA_2022
    ) %>%
    filter(ESTADO_PROGRAMA_2021 != ESTADO_PROGRAMA_2022)
}
...
cine_snies <- read_excel("data/SNIES_CINE_raw/programas_nivel_nacional_vigencia_2025.xlsx") %>% 
...
write_xlsx(base_cine_filtrada, "data/SNIES_CINE_cleaned/base_cine_programas_vigencia_2025_18072025.xlsx")
...
write_csv(data, "data/BD/icfes_cine_programas_vigencia_2025_cruce_nacional.csv")
write_xlsx(data,"data/BD/icfes_cine_programas_vigencia_2025_cruce_nacional.xlsx")
