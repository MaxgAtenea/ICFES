...
#data utilizada para la estimacion
data <- read_delim("data/BD/data_estimacion_todos_periodos.csv", escape_double = FALSE, trim_ws = TRUE)
data_2023 <- read_delim("data/BD/data_estimacion_2023.csv", escape_double = FALSE, trim_ws = TRUE)

#resultados de los VA para cada ICINE a nivel CINE
resultados_va <- read_delim("data/Resultados/va_icine_bogota_region.csv", escape_double = FALSE, trim_ws = TRUE)
resultados_va_2023 <- read_delim("data/Resultados/va_icine_bogota_region_2023.csv", escape_double = FALSE, trim_ws = TRUE)
